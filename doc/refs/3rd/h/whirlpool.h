...
#define _WHIRLPOOL_DIGEST_SIZE 64
#define _WHIRLPOOL_BLOCK_SIZE 64
...
typedef struct NESSIEstruct {
	...
	unsigned char ipad[_WHIRLPOOL_BLOCK_SIZE];
	unsigned char opad[_WHIRLPOOL_BLOCK_SIZE];
} NESSIEstruct;
...
void WHIRLPOOL_add(const unsigned char * const source, unsigned int sourceBits, struct NESSIEstruct * const structpointer);
